...
//
//	mockgen -source=transcriber.go -destination=mock/transcriber.go -package=mock
//
...
func (m *MockTranscriber) Transcribe(ctx context.Context, reader io.ReadCloser) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Transcribe", ctx, reader)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTranscriberMockRecorder) Transcribe(ctx, reader any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Transcribe", reflect.TypeOf((*MockTranscriber)(nil).Transcribe), ctx, reader)
}
